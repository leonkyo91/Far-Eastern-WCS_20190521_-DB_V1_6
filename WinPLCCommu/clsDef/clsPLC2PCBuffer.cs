...
namespace Mirle.WinPLCCommu
{
    public class clsPLC2PCBuffer
    {
        ...
        /// 站口模式碼 Bit12:荷有(左)
        /// </summary>
        public bool StnModeCode_LeftLoad
        {
            get;
            set;
        }
        ...
        /// 站口模式碼 Bit13:荷有(右)
        /// </summary>
        public bool StnModeCode_RightLoad
        {
            get;
            set;
        }
