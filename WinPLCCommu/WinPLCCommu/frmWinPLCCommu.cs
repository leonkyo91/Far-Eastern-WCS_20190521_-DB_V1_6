...
namespace Mirle.WinPLCCommu
{
    public partial class frmWinPLCCommu : Form
    {
                        ...
                        Parallel.For(0, objBufferData.PLC2PCBuffer.Length, intItem =>
                            {
                                if (dicBufferMap.ContainsKey(intItem))
                                {
                                    ...
                                    BufferControl.FunNotice = clsTool.funGetEnumValue<uclBuffer.enuFunNotice>(objBufferData.PLC2PCBuffer[intItem].FunNotice);
                                    ...
                                    {
                                        if (objBufferData.PLC2PCBuffer[intItem].StnModeCode_Load)
                                        {
                                            //內Buffer有序號時顯示於字幕機                                     
                                    ...
                                    else if (!objBufferData.PLC2PCBuffer[intItem].StnModeCode_Load)
                                    {
                                    }
        ...
        private void ptbB01_DoubleClick(object sender, EventArgs e)
        {
            if (MessageBox.Show("確定更換站口(B01)方向?", "", MessageBoxButtons.YesNo, MessageBoxIcon.Warning) == DialogResult.Yes)
            {

                if (ptbB01.Tag == "IN")
                {
                    ptbB01.Tag = "OUT";
                    ptbB01.Image = global::Mirle.WinPLCCommu.Properties.Resources.Bottom;
                }
                else
                {
                    ptbB01.Tag = "IN";
                    ptbB01.Image = global::Mirle.WinPLCCommu.Properties.Resources.Top;
                }
            }
        }

        private void ptbB02_DoubleClick(object sender, EventArgs e)
        {
            if (MessageBox.Show("確定更換站口(B02)方向?", "", MessageBoxButtons.YesNo, MessageBoxIcon.Warning) == DialogResult.Yes)
            {

                if (ptbB02.Tag == "IN")
                {
                    ptbB02.Tag = "OUT";
                    ptbB02.Image = global::Mirle.WinPLCCommu.Properties.Resources.Bottom;
                }
                else
                {
                    ptbB02.Tag = "IN";
                    ptbB02.Image = global::Mirle.WinPLCCommu.Properties.Resources.Top;
                }
            }
        }

        private void ptbB03_DoubleClick(object sender, EventArgs e)
        {
            if (MessageBox.Show("確定更換站口(B03)方向?", "", MessageBoxButtons.YesNo, MessageBoxIcon.Warning) == DialogResult.Yes)
            {

                if (ptbB03.Tag == "IN")
                {
                    ptbB03.Tag = "OUT";
                    ptbB03.Image = global::Mirle.WinPLCCommu.Properties.Resources.Bottom;
                }
                else
                {
                    ptbB03.Tag = "IN";
                    ptbB03.Image = global::Mirle.WinPLCCommu.Properties.Resources.Top;
                }
            }
        }

        private void ptbB04_DoubleClick(object sender, EventArgs e)
        {
            if (MessageBox.Show("確定更換站口(B04)方向?", "", MessageBoxButtons.YesNo, MessageBoxIcon.Warning) == DialogResult.Yes)
            {

                if (ptbB04.Tag == "IN")
                {
                    ptbB04.Tag = "OUT";
                    ptbB04.Image = global::Mirle.WinPLCCommu.Properties.Resources.Bottom;
                }
                else
                {
                    ptbB04.Tag = "IN";
                    ptbB04.Image = global::Mirle.WinPLCCommu.Properties.Resources.Top;
                }
            }
        }

        private void ptbB05_DoubleClick(object sender, EventArgs e)
        {
            if (MessageBox.Show("確定更換站口(B05)方向?", "", MessageBoxButtons.YesNo, MessageBoxIcon.Warning) == DialogResult.Yes)
            {

                if (ptbB05.Tag == "IN")
                {
                    ptbB05.Tag = "OUT";
                    ptbB05.Image = global::Mirle.WinPLCCommu.Properties.Resources.Bottom;
                }
                else
                {
                    ptbB05.Tag = "IN";
                    ptbB05.Image = global::Mirle.WinPLCCommu.Properties.Resources.Top;
                }
            }
        }

        private void ptbB06_DoubleClick(object sender, EventArgs e)
        {
            if (MessageBox.Show("確定更換站口(B06)方向?", "", MessageBoxButtons.YesNo, MessageBoxIcon.Warning) == DialogResult.Yes)
            {

                if (ptbB06.Tag == "IN")
                {
                    ptbB06.Tag = "OUT";
                    ptbB06.Image = global::Mirle.WinPLCCommu.Properties.Resources.Bottom;
                }
                else
                {
                    ptbB06.Tag = "IN";
                    ptbB06.Image = global::Mirle.WinPLCCommu.Properties.Resources.Top;
                }
            }
        }

        private void ptbC01_DoubleClick(object sender, EventArgs e)
        {
            if (MessageBox.Show("確定更換站口(C01)方向?", "", MessageBoxButtons.YesNo, MessageBoxIcon.Warning) == DialogResult.Yes)
            {

                if (ptbC01.Tag == "IN")
                {
                    ptbC01.Tag = "OUT";
                    ptbC01.Image = global::Mirle.WinPLCCommu.Properties.Resources.Bottom;
                }
                else
                {
                    ptbC01.Tag = "IN";
                    ptbC01.Image = global::Mirle.WinPLCCommu.Properties.Resources.Top;
                }
            }
        }

        private void ptbC02_DoubleClick(object sender, EventArgs e)
        {
            if (MessageBox.Show("確定更換站口(C02)方向?", "", MessageBoxButtons.YesNo, MessageBoxIcon.Warning) == DialogResult.Yes)
            {

                if (ptbC02.Tag == "IN")
                {
                    ptbC02.Tag = "OUT";
                    ptbC02.Image = global::Mirle.WinPLCCommu.Properties.Resources.Bottom;
                }
                else
                {
                    ptbC02.Tag = "IN";
                    ptbC02.Image = global::Mirle.WinPLCCommu.Properties.Resources.Top;
                }
            }
        }

        private void ptbC03_DoubleClick(object sender, EventArgs e)
        {
            if (MessageBox.Show("確定更換站口(C03)方向?", "", MessageBoxButtons.YesNo, MessageBoxIcon.Warning) == DialogResult.Yes)
            {

                if (ptbC03.Tag == "IN")
                {
                    ptbC03.Tag = "OUT";
                    ptbC03.Image = global::Mirle.WinPLCCommu.Properties.Resources.Bottom;
                }
                else
                {
                    ptbC03.Tag = "IN";
                    ptbC03.Image = global::Mirle.WinPLCCommu.Properties.Resources.Top;
                }
            }
        }

        private void ptbC04_DoubleClick(object sender, EventArgs e)
        {
            if (MessageBox.Show("確定更換站口(C04)方向?", "", MessageBoxButtons.YesNo, MessageBoxIcon.Warning) == DialogResult.Yes)
            {

                if (ptbC04.Tag == "IN")
                {
                    ptbC04.Tag = "OUT";
                    ptbC04.Image = global::Mirle.WinPLCCommu.Properties.Resources.Bottom;
                }
                else
                {
                    ptbC04.Tag = "IN";
                    ptbC04.Image = global::Mirle.WinPLCCommu.Properties.Resources.Top;
                }
            }
        }

        private void ptbC05_DoubleClick(object sender, EventArgs e)
        {
            if (MessageBox.Show("確定更換站口(C05)方向?", "", MessageBoxButtons.YesNo, MessageBoxIcon.Warning) == DialogResult.Yes)
            {

                if (ptbC05.Tag == "IN")
                {
                    ptbC05.Tag = "OUT";
                    ptbC05.Image = global::Mirle.WinPLCCommu.Properties.Resources.Bottom;
                }
                else
                {
                    ptbC05.Tag = "IN";
                    ptbC05.Image = global::Mirle.WinPLCCommu.Properties.Resources.Top;
                }
            }
        }

        private void ptbC06_DoubleClick(object sender, EventArgs e)
        {
            if (MessageBox.Show("確定更換站口(C06)方向?", "", MessageBoxButtons.YesNo, MessageBoxIcon.Warning) == DialogResult.Yes)
            {

                if (ptbC06.Tag == "IN")
                {
                    ptbC06.Tag = "OUT";
                    ptbC06.Image = global::Mirle.WinPLCCommu.Properties.Resources.Bottom;
                }
                else
                {
                    ptbC06.Tag = "IN";
                    ptbC06.Image = global::Mirle.WinPLCCommu.Properties.Resources.Top;
                }
            }
        }

        private void ptbD01_DoubleClick(object sender, EventArgs e)
        {
            if (MessageBox.Show("確定更換站口(D01)方向?", "", MessageBoxButtons.YesNo, MessageBoxIcon.Warning) == DialogResult.Yes)
            {

                if (ptbD01.Tag == "IN")
                {
                    ptbD01.Tag = "OUT";
                    ptbD01.Image = global::Mirle.WinPLCCommu.Properties.Resources.Bottom;
                }
                else
                {
                    ptbD01.Tag = "IN";
                    ptbD01.Image = global::Mirle.WinPLCCommu.Properties.Resources.Top;
                }
            }
        }

        private void ptbD02_DoubleClick(object sender, EventArgs e)
        {
            if (MessageBox.Show("確定更換站口(D02)方向?", "", MessageBoxButtons.YesNo, MessageBoxIcon.Warning) == DialogResult.Yes)
            {

                if (ptbD02.Tag == "IN")
                {
                    ptbD02.Tag = "OUT";
                    ptbD02.Image = global::Mirle.WinPLCCommu.Properties.Resources.Bottom;
                }
                else
                {
                    ptbD02.Tag = "IN";
                    ptbD02.Image = global::Mirle.WinPLCCommu.Properties.Resources.Top;
                }
            }
        }

        private void ptbD03_DoubleClick(object sender, EventArgs e)
        {
            if (MessageBox.Show("確定更換站口(D03)方向?", "", MessageBoxButtons.YesNo, MessageBoxIcon.Warning) == DialogResult.Yes)
            {

                if (ptbD03.Tag == "IN")
                {
                    ptbD03.Tag = "OUT";
                    ptbD03.Image = global::Mirle.WinPLCCommu.Properties.Resources.Bottom;
                }
                else
                {
                    ptbD03.Tag = "IN";
                    ptbD03.Image = global::Mirle.WinPLCCommu.Properties.Resources.Top;
                }
            }
        }

        private void ptbD04_DoubleClick(object sender, EventArgs e)
        {
            if (MessageBox.Show("確定更換站口(D04)方向?", "", MessageBoxButtons.YesNo, MessageBoxIcon.Warning) == DialogResult.Yes)
            {

                if (ptbD04.Tag == "IN")
                {
                    ptbD04.Tag = "OUT";
                    ptbD04.Image = global::Mirle.WinPLCCommu.Properties.Resources.Bottom;
                }
                else
                {
                    ptbD04.Tag = "IN";
                    ptbD04.Image = global::Mirle.WinPLCCommu.Properties.Resources.Top;
                }
            }
        }

        private void ptbD05_DoubleClick(object sender, EventArgs e)
        {
            if (MessageBox.Show("確定更換站口(D05)方向?", "", MessageBoxButtons.YesNo, MessageBoxIcon.Warning) == DialogResult.Yes)
            {

                if (ptbD05.Tag == "IN")
                {
                    ptbD05.Tag = "OUT";
                    ptbD05.Image = global::Mirle.WinPLCCommu.Properties.Resources.Bottom;
                }
                else
                {
                    ptbD05.Tag = "IN";
                    ptbD05.Image = global::Mirle.WinPLCCommu.Properties.Resources.Top;
                }
            }
        }

        private void ptbD06_DoubleClick(object sender, EventArgs e)
        {
            if (MessageBox.Show("確定更換站口(D06)方向?", "", MessageBoxButtons.YesNo, MessageBoxIcon.Warning) == DialogResult.Yes)
            {

                if (ptbD06.Tag == "IN")
                {
                    ptbD06.Tag = "OUT";
                    ptbD06.Image = global::Mirle.WinPLCCommu.Properties.Resources.Bottom;
                }
                else
                {
                    ptbD06.Tag = "IN";
                    ptbD06.Image = global::Mirle.WinPLCCommu.Properties.Resources.Top;
                }
            }
        }

        private void ptbE01_DoubleClick(object sender, EventArgs e)
        {
            if (MessageBox.Show("確定更換站口(E01)方向?", "", MessageBoxButtons.YesNo, MessageBoxIcon.Warning) == DialogResult.Yes)
            {

                if (ptbE01.Tag == "IN")
                {
                    ptbE01.Tag = "OUT";
                    ptbE01.Image = global::Mirle.WinPLCCommu.Properties.Resources.Bottom;
                }
                else
                {
                    ptbE01.Tag = "IN";
                    ptbE01.Image = global::Mirle.WinPLCCommu.Properties.Resources.Top;
                }
            }
        }

        private void ptbE02_DoubleClick(object sender, EventArgs e)
        {
            if (MessageBox.Show("確定更換站口(E02)方向?", "", MessageBoxButtons.YesNo, MessageBoxIcon.Warning) == DialogResult.Yes)
            {

                if (ptbE02.Tag == "IN")
                {
                    ptbE02.Tag = "OUT";
                    ptbE02.Image = global::Mirle.WinPLCCommu.Properties.Resources.Bottom;
                }
                else
                {
                    ptbE02.Tag = "IN";
                    ptbE02.Image = global::Mirle.WinPLCCommu.Properties.Resources.Top;
                }
            }
        }

        private void ptbE03_DoubleClick(object sender, EventArgs e)
        {
            if (MessageBox.Show("確定更換站口(E03)方向?", "", MessageBoxButtons.YesNo, MessageBoxIcon.Warning) == DialogResult.Yes)
            {

                if (ptbE03.Tag == "IN")
                {
                    ptbE03.Tag = "OUT";
                    ptbE03.Image = global::Mirle.WinPLCCommu.Properties.Resources.Bottom;
                }
                else
                {
                    ptbE03.Tag = "IN";
                    ptbE03.Image = global::Mirle.WinPLCCommu.Properties.Resources.Top;
                }
            }
        }

        private void ptbE04_DoubleClick(object sender, EventArgs e)
        {
            if (MessageBox.Show("確定更換站口(E04)方向?", "", MessageBoxButtons.YesNo, MessageBoxIcon.Warning) == DialogResult.Yes)
            {

                if (ptbE04.Tag == "IN")
                {
                    ptbE04.Tag = "OUT";
                    ptbE04.Image = global::Mirle.WinPLCCommu.Properties.Resources.Bottom;
                }
                else
                {
                    ptbE04.Tag = "IN";
                    ptbE04.Image = global::Mirle.WinPLCCommu.Properties.Resources.Top;
                }
            }
        }

        private void ptbE05_DoubleClick(object sender, EventArgs e)
        {
            if (MessageBox.Show("確定更換站口(E05)方向?", "", MessageBoxButtons.YesNo, MessageBoxIcon.Warning) == DialogResult.Yes)
            {

                if (ptbE05.Tag == "IN")
                {
                    ptbE05.Tag = "OUT";
                    ptbE05.Image = global::Mirle.WinPLCCommu.Properties.Resources.Bottom;
                }
                else
                {
                    ptbE05.Tag = "IN";
                    ptbE05.Image = global::Mirle.WinPLCCommu.Properties.Resources.Top;
                }
            }
        }

        private void ptbE06_DoubleClick(object sender, EventArgs e)
        {
            if (MessageBox.Show("確定更換站口(E06)方向?", "", MessageBoxButtons.YesNo, MessageBoxIcon.Warning) == DialogResult.Yes)
            {

                if (ptbE06.Tag == "IN")
                {
                    ptbE06.Tag = "OUT";
                    ptbE06.Image = global::Mirle.WinPLCCommu.Properties.Resources.Bottom;
                }
                else
                {
                    ptbE06.Tag = "IN";
                    ptbE06.Image = global::Mirle.WinPLCCommu.Properties.Resources.Top;
                }
            }
        }

        private void ptbF01_DoubleClick(object sender, EventArgs e)
        {
            if (MessageBox.Show("確定更換站口(F01)方向?", "", MessageBoxButtons.YesNo, MessageBoxIcon.Warning) == DialogResult.Yes)
            {

                if (ptbF01.Tag == "IN")
                {
                    ptbF01.Tag = "OUT";
                    ptbF01.Image = global::Mirle.WinPLCCommu.Properties.Resources.Bottom;
                }
                else
                {
                    ptbF01.Tag = "IN";
                    ptbF01.Image = global::Mirle.WinPLCCommu.Properties.Resources.Top;
                }
            }
        }

        private void ptbF02_DoubleClick(object sender, EventArgs e)
        {
            if (MessageBox.Show("確定更換站口(F02)方向?", "", MessageBoxButtons.YesNo, MessageBoxIcon.Warning) == DialogResult.Yes)
            {

                if (ptbF02.Tag == "IN")
                {
                    ptbF02.Tag = "OUT";
                    ptbF02.Image = global::Mirle.WinPLCCommu.Properties.Resources.Bottom;
                }
                else
                {
                    ptbF02.Tag = "IN";
                    ptbF02.Image = global::Mirle.WinPLCCommu.Properties.Resources.Top;
                }
            }
        }

        private void ptbF03_DoubleClick(object sender, EventArgs e)
        {
            if (MessageBox.Show("確定更換站口(F03)方向?", "", MessageBoxButtons.YesNo, MessageBoxIcon.Warning) == DialogResult.Yes)
            {

                if (ptbF03.Tag == "IN")
                {
                    ptbF03.Tag = "OUT";
                    ptbF03.Image = global::Mirle.WinPLCCommu.Properties.Resources.Bottom;
                }
                else
                {
                    ptbF03.Tag = "IN";
                    ptbF03.Image = global::Mirle.WinPLCCommu.Properties.Resources.Top;
                }
            }
        }

        private void ptbF04_DoubleClick(object sender, EventArgs e)
        {
            if (MessageBox.Show("確定更換站口(F04)方向?", "", MessageBoxButtons.YesNo, MessageBoxIcon.Warning) == DialogResult.Yes)
            {

                if (ptbF04.Tag == "IN")
                {
                    ptbF04.Tag = "OUT";
                    ptbF04.Image = global::Mirle.WinPLCCommu.Properties.Resources.Bottom;
                }
                else
                {
                    ptbF04.Tag = "IN";
                    ptbF04.Image = global::Mirle.WinPLCCommu.Properties.Resources.Top;
                }
            }
        }

        private void ptbF05_DoubleClick(object sender, EventArgs e)
        {
            if (MessageBox.Show("確定更換站口(F05)方向?", "", MessageBoxButtons.YesNo, MessageBoxIcon.Warning) == DialogResult.Yes)
            {

                if (ptbF05.Tag == "IN")
                {
                    ptbF05.Tag = "OUT";
                    ptbF05.Image = global::Mirle.WinPLCCommu.Properties.Resources.Bottom;
                }
                else
                {
                    ptbF05.Tag = "IN";
                    ptbF05.Image = global::Mirle.WinPLCCommu.Properties.Resources.Top;
                }
            }
        }

        private void ptbF06_DoubleClick(object sender, EventArgs e)
        {
            if (MessageBox.Show("確定更換站口(F06)方向?", "", MessageBoxButtons.YesNo, MessageBoxIcon.Warning) == DialogResult.Yes)
            {

                if (ptbF06.Tag == "IN")
                {
                    ptbF06.Tag = "OUT";
                    ptbF06.Image = global::Mirle.WinPLCCommu.Properties.Resources.Bottom;
                }
                else
                {
                    ptbF06.Tag = "IN";
                    ptbF06.Image = global::Mirle.WinPLCCommu.Properties.Resources.Top;
                }
            }
        }

        private void ptbG01_DoubleClick(object sender, EventArgs e)
        {
            if (MessageBox.Show("確定更換站口(G01)方向?", "", MessageBoxButtons.YesNo, MessageBoxIcon.Warning) == DialogResult.Yes)
            {

                if (ptbG01.Tag == "IN")
                {
                    ptbG01.Tag = "OUT";
                    ptbG01.Image = global::Mirle.WinPLCCommu.Properties.Resources.Bottom;
                }
                else
                {
                    ptbG01.Tag = "IN";
                    ptbG01.Image = global::Mirle.WinPLCCommu.Properties.Resources.Top;
                }
            }
        }

        private void ptbG02_DoubleClick(object sender, EventArgs e)
        {
            if (MessageBox.Show("確定更換站口(G02)方向?", "", MessageBoxButtons.YesNo, MessageBoxIcon.Warning) == DialogResult.Yes)
            {

                if (ptbG02.Tag.ToString().ToUpper() == "IN")
                {
                    ptbG02.Tag = "OUT";
                    ptbG02.Image = global::Mirle.WinPLCCommu.Properties.Resources.Bottom;
                }
                else
                {
                    ptbG02.Tag = "IN";
                    ptbG02.Image = global::Mirle.WinPLCCommu.Properties.Resources.Top;
                }
            }
        }

        private void ptbG03_DoubleClick(object sender, EventArgs e)
        {
            if (MessageBox.Show("確定更換站口(G03)方向?", "", MessageBoxButtons.YesNo, MessageBoxIcon.Warning) == DialogResult.Yes)
            {

                if (ptbG03.Tag == "IN")
                {
                    ptbG03.Tag = "OUT";
                    ptbG03.Image = global::Mirle.WinPLCCommu.Properties.Resources.Bottom;
                }
                else
                {
                    ptbG03.Tag = "IN";
                    ptbG03.Image = global::Mirle.WinPLCCommu.Properties.Resources.Top;
                }
            }
        }

        private void ptbG04_DoubleClick(object sender, EventArgs e)
        {
            if (MessageBox.Show("確定更換站口(G04)方向?", "", MessageBoxButtons.YesNo, MessageBoxIcon.Warning) == DialogResult.Yes)
            {

                if (ptbG04.Tag == "IN")
                {
                    ptbG04.Tag = "OUT";
                    ptbG04.Image = global::Mirle.WinPLCCommu.Properties.Resources.Bottom;
                }
                else
                {
                    ptbG04.Tag = "IN";
                    ptbG04.Image = global::Mirle.WinPLCCommu.Properties.Resources.Top;
                }
            }
        }

        private void ptbG05_DoubleClick(object sender, EventArgs e)
        {
            if (MessageBox.Show("確定更換站口(G05)方向?", "", MessageBoxButtons.YesNo, MessageBoxIcon.Warning) == DialogResult.Yes)
            {

                if (ptbG05.Tag == "IN")
                {
                    ptbG05.Tag = "OUT";
                    ptbG05.Image = global::Mirle.WinPLCCommu.Properties.Resources.Bottom;
                }
                else
                {
                    ptbG05.Tag = "IN";
                    ptbG05.Image = global::Mirle.WinPLCCommu.Properties.Resources.Top;
                }
            }
        }

        private void ptbG06_DoubleClick(object sender, EventArgs e)
        {
            if (MessageBox.Show("確定更換站口(G06)方向?", "", MessageBoxButtons.YesNo, MessageBoxIcon.Warning) == DialogResult.Yes)
            {

                if (ptbG06.Tag == "IN")
                {
                    ptbG06.Tag = "OUT";
                    ptbG06.Image = global::Mirle.WinPLCCommu.Properties.Resources.Bottom;
                }
                else
                {
                    ptbG06.Tag = "IN";
                    ptbG06.Image = global::Mirle.WinPLCCommu.Properties.Resources.Top;
                }
            }
        }
